        ...
        ZStack {
            ...
            ScrollView(.vertical, showsIndicators: false) {
                ...
                VStack {
                    HStack {
                        Text("Font")
                            .font(userSettings.monkeyBusinessFont ? .custom("PlayfairDisplay-Regular", size: userSettings.titleFontSize) : .subheadline)
                            .fontWeight(.bold)
                    ...
                    HStack {
                        Toggle(isOn: $userSettings.monkeyBusinessFont) {
                            Text("News Font")
                                .font(.custom("PlayfairDisplay-Regular", size: userSettings.bodyFontSize))
                                .foregroundColor(Color("MainText"))
                        }
                    }
                }
                ...
                VStack {
                    ...
                    Picker(selection: $userSettings.setLang, label: Text("Language")) {
                        Text("Russian").tag(0)
                        Text("Ukrainian").tag(1)
                ...
                Text("\(String(Calendar.current.component(.year, from: Date()))) • powered by constantinekos")
                    .font(.subheadline)
            ...
            //.frame(width: self.width - 40)
            .onAppear {
                self.trackScreen(name: "FAQ_Screen", parameters: nil)
            }
        }
    }
        ...
        VStack {
            ...
            HStack {
                ...
                Text("It means that we check the fact of that post")
                    .font(userSettings.monkeyBusinessFont ? .custom("PlayfairDisplay-Regular", size: userSettings.bodyFontSize) : .body)
                    .foregroundColor(Color("MainText"))
                Spacer()
            }
            ...
            HStack {
                ...
                Text("You may open the website to read the news feed")
                    .font(userSettings.monkeyBusinessFont ? .custom("PlayfairDisplay-Regular", size: userSettings.bodyFontSize) : .body)
                    .foregroundColor(Color("MainText"))
                Spacer()
            }
            ...
            HStack {
                ...
                Text("You may read the post on the website")
                    .font(userSettings.monkeyBusinessFont ? .custom("PlayfairDisplay-Regular", size: userSettings.bodyFontSize) : .body)
                    .foregroundColor(Color("MainText"))
                Spacer()
            }
...
struct CodexComponent: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            //TITLE
            Text("Codex – Україна")
                .font(userSettings.monkeyBusinessFont ? .custom("PlayfairDisplay-Regular", size: userSettings.titleFontSize) : .body)
                .fontWeight(.bold)
                .foregroundColor(Color("MainText"))
                .padding()
            ...
            if self.expand {
                ...
                Text("Body")
                    ...
                    .padding()
                    .onAppear {
                        Analytics.logEvent("codex_expand", parameters: nil)
                }
                .onDisappear{
                    Analytics.logEvent("codex_shrink", parameters: nil)
                }
            }
...
struct Monetization: View {
    ...
    var body: some View {
        VStack {
            ...
            Text("We use Google Advertisement as the only way to monetize the content")
                .font(userSettings.monkeyBusinessFont ? .custom("PlayfairDisplay-Regular", size: userSettings.bodyFontSize) : .body)
                .foregroundColor(Color("MainText"))
        }
        .padding()
...
public class UserSettings: ObservableObject {
    ...
    @Published var monkeyBusinessFont: Bool {
        didSet {
            ...
            Analytics.setUserProperty(font, forName: "NewsFont")
        }
       
    }
    @Published var setLang: Int {
        didSet {
            UserDefaults.standard.set(setLang, forKey: "setLang")
        }
    }
    
    init() {
        self.monkeyBusinessFont = UserDefaults.standard.object(forKey: "monkeyBusinessFont") as? Bool ?? true
        self.setLang = UserDefaults.standard.object(forKey: "setLang") as? Int ?? 0
    }
